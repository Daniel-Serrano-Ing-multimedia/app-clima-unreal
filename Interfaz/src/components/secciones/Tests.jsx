...
import { pronostico, defaultText, obtenerEmbalsesUnreal } from '../../unrealComunications/hidromet';
// funciones hidomet
...
const Tests = () => {
  ...
  <Grid container item >
    ...
    <Grid item xs = {4}>
      <ButtonReact 
        unrealFunc = { () => obtenerEmbalses }
        textButton = { 'Obtener Embalses' }
      />
    </Grid>
    <Grid item xs = {4}>
      <ButtonReact 
        unrealFunc = { () => obtenerEmbalsesUnreal }
        textButton = { 'Obtener Embalses Unrela' }
      />
    </Grid>
  </Grid>
